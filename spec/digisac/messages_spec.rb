  ...
  describe "#send_message_to_contact_id", :vcr do
    ...
    it 'send picture' do
      expect(subject.send_message_to_contact_id("9c0007c1-83a5-4d1d-a96e-ee164b1b8f62", "Hello",
        { 'dontOpenTicket': true, 'file_url': 'https://miro.medium.com/proxy/1*sZSVVtdP9TE3mUoGh4GoYA.png' })).to include(:ok)
    end

    it 'send video' do
      expect(subject.send_message_to_contact_id("9c0007c1-83a5-4d1d-a96e-ee164b1b8f62", "Hello",
        { 'dontOpenTicket': true, 'file_url': 'https://media.giphy.com/media/fXJyMfUdqVCMPAnPJM/giphy.mp4' })).to include(:ok)
    end
